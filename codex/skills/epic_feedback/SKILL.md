...
- Do not write `## Plan Review Log`; that remains owned only by `epic_story_plan_review`.
...
"Recommended next: run `epic_story_plan_review $EPIC <NN>` from a fresh session to re-validate the amended plan."
