...
The tracker has a header row and a separator row only — zero data rows. Match the six-column standard even though the epic starts empty; future story creation will slot into those columns.
